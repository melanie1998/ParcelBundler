...
class BundleGraph {
  ...
  resolveSymbol(asset, symbol, boundary) {
    ...
    if (potentialResults.length == 1) {
      ...
      var _asset$symbols4, _asset$symbols5, _asset$symbols5$get;

      // ... and there is no single reexport, but `bailout` tells us if it might still be exported.
      return {
        asset,
        exportSymbol: symbol,
        symbol: identifier !== null && identifier !== void 0 ? identifier : bailout || ((_asset$symbols4 = asset.symbols) === null || _asset$symbols4 === void 0 ? void 0 : _asset$symbols4.has('*')) ? null : undefined,
        loc: (_asset$symbols5 = asset.symbols) === null || _asset$symbols5 === void 0 ? void 0 : (_asset$symbols5$get = _asset$symbols5.get(symbol)) === null || _asset$symbols5$get === void 0 ? void 0 : _asset$symbols5$get.loc
      };
    }
  }
