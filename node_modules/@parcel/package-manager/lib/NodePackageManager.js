  ...
  async resolve(name, from, options) {
    ...
    if (!resolved) {
      try {
        ...
        if (e.code !== 'MODULE_NOT_FOUND' || (options === null || options === void 0 ? void 0 : options.autoinstall) !== true) {
          throw e;
        }
      ...
      if (range != null) {
        ...
        if (pkg == null || !_semver().default.satisfies(pkg.version, range)) {
          ...
          if (conflicts == null && (options === null || options === void 0 ? void 0 : options.autoinstall) === true) {
            await this.install([{
              name,
              range
            }], from);
