...
class TSModuleGraph {
  constructor(ts, mainModuleName) {
    _defineProperty(this, "ts", void 0);

    _defineProperty(this, "modules", void 0);

    _defineProperty(this, "mainModuleName", void 0);

    _defineProperty(this, "mainModule", void 0);
  ...
  markUsed(module, name, context) {
    let {
      ts
    } = this; // If name is imported, mark used in the original module
